...
function GameApp() {
  ...
  if (initResult === 'notfound') return <Message color='warning'>Game Not found</Message>
  if (initResult === 'intruder') return <Message color='warning'>The game is already full</Message>
  else return (
